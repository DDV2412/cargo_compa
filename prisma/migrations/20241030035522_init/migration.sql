...
CREATE TABLE `users` (
    ...
    `eoriNumber` VARCHAR(191) NULL,
    `kboNumber` VARCHAR(191) NULL,
    `kboFile` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `users_email_key`(`email`),
    UNIQUE INDEX `users_vatNumber_key`(`vatNumber`),
    UNIQUE INDEX `users_eoriNumber_key`(`eoriNumber`),
    UNIQUE INDEX `users_kboNumber_key`(`kboNumber`),
    PRIMARY KEY (`id`)
